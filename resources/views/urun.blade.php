        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb-tree">
                    ...
                    <li><a href="{{route('kategori',$alt_kategori->slug)}}">{{$alt_kategori->title}}</a></li>
{{--                    <li><a href="{{route('kategori',$urun->slug)}}">{{$urun->title}}</a></li>--}}

                    <li class="active">{{$urun->title}}</li>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    <h2 class="product-name">{{$urun->adi}}</h2>
                    <div>
                        <h3 class="product-price">{{$urun->price}}₺</h3>
